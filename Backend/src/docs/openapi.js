const swaggerDocument = {
  ...
  info: {
    title: 'TaskFlow API',
    version: '1.0.0',
    description: 'TaskFlow multi-tenant project and task management API implemented in this repository.',
  },
    ...
    schemas: {
      ...
      UserSummary: {
        ...
        properties: {
          ...
          platformRole: { type: 'string', enum: ['user', 'platform_admin'] },
        },
      },
      Project: {
        type: 'object',
      ...
      AuthRegisterRequest: {
        ...
        properties: {
          ...
          organizationName: { type: 'string', minLength: 1, maxLength: 150 },
          role: { type: 'string', enum: ['platform_admin', 'org_admin', 'member'], default: 'org_admin' },
        },
      },
      AuthLoginRequest: {
        type: 'object',
  ...
  paths: {
    ...
    '/api/auth/logout': {
      post: {
        summary: 'Revoke a refresh token for the current user',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: false,
          content: {
    ...
    '/api/platform/dashboard': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          200: { description: 'Platform summary values' },
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['name'],
                properties: { name: { type: 'string' }, adminUserId: { type: 'string', format: 'uuid' } },
              },
            },
          },
        },
    ...
    '/api/platform/users/{userId}': {
      ...
      patch: {
        summary: 'Update a user platform role',
        security: [{ bearerAuth: [] }],
        parameters: [{ $ref: '#/components/parameters/UserIdParam' }],
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: {
                ...
                properties: { platformRole: { type: 'string', enum: ['user', 'platform_admin'] } },
              },
            },
          },
        },
    ...
    '/api/platform/organizations/{organizationId}/members': {
      post: {
        ...
        responses: {
          ...
          409: { description: 'User already is a member' },
        },
      },
    },
    '/api/platform/organizations/{organizationId}/members/{userId}/promote': {
      patch: {
        summary: 'Promote a user to org admin in an organization',
        security: [{ bearerAuth: [] }],
        parameters: [
    ...
    '/api/dashboard/org': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          200: { description: 'Organization dashboard summary' },
          403: { description: 'Forbidden' },
        },
      },
    },
    '/api/dashboard/member': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          200: { description: 'Member dashboard summary' },
          403: { description: 'Forbidden' },
        },
      },
    },
    ...
    '/api/tasks/projects/{projectId}': {
      get: {
        ...
        parameters: [
          ...
          { $ref: '#/components/parameters/TaskAssigneeQuery' },
          { $ref: '#/components/parameters/DueDateFromQuery' },
          { $ref: '#/components/parameters/DueDateToQuery' },
    ...
    '/api/tasks/projects/{projectId}/dashboard': {
      get: {
        summary: 'Get task count dashboard for a project',
        security: [{ bearerAuth: [] }],
        parameters: [{ $ref: '#/components/parameters/ProjectIdParam' }],
        responses: { 200: { description: 'Task distribution by status' } },
      },
    },
    '/api/tasks/bulk-status': {
      patch: {
        summary: 'Update multiple tasks to the same status',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/BulkTaskStatusRequest' } },
          },
        },
    ...
    '/api/tasks/{taskId}': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        parameters: [{ $ref: '#/components/parameters/TaskIdParam' }],
    ...
    '/api/tasks/{taskId}/assign': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/TaskAssignmentRequest' } } },
        },
        responses: { 201: { description: 'Assignment created' }, 409: { description: 'Task already assigned to user' } },
      },
    },
    '/api/tasks/{taskId}/unassign': {
      post: {
        ...
        responses: { 200: { description: 'Assignment removed' }, 404: { description: 'Task not found' } },
      },
    },
    '/api/members': {
      get: {
      ...
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/MemberAddRequest' } } },
        },
    ...
    '/api/members/{memberId}': {
      patch: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/MemberRoleUpdateRequest' } } },
        },
    ...
    '/api/jobs/{id}': {
      get: {
        ...
        responses: {
          200: { description: 'Job status information' },
          403: { description: 'Forbidden' },
  ...
  components: {
    ...((() => { const base = { securitySchemes: { bearerAuth: { type: 'http', scheme: 'bearer', bearerFormat: 'JWT' } }, schemas: {} }; return base; })()),
    parameters: {
      OrganizationIdParam: {
        name: 'organizationId',
        in: 'path',
